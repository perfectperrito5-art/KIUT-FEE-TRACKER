...
CREATE TABLE `users` (
  ...
  `role` enum('admin','finance','student') NOT NULL,
...
INSERT INTO `users` VALUES (1,'admin1','1234','admin','2026-02-14 18:03:31'),(2,'finance1','1234','finance','2026-02-14 18:03:31'),(3,'student1','1234','student','2026-02-14 18:03:31');
